...
tile = '/home/pu17449/data2/soilgrids/CLYPPT_M_ave_250m_ll.tif'
# Shapefiles of catchment boundaries
catchdir = '/home/pu17449/data2/Discharge Data/GRDC_daily_global/shapefiles'
# Output directory
outdir = '/home/pu17449/data2/parameter_transfer_catchments/clyppt'
# Pickle file containing mean values for slope over each catchment
mean_out = '/home/pu17449/data2/parameter_transfer_catchments/clyppt.pkl'
...
for catchment in catchments:
	...
	try:
		...
		outfile = os.path.join(outdir,'clyppt_'+catchid+'.tif')
