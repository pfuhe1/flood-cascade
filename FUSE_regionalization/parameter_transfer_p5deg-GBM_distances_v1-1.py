...
# Input paths
gridpath = '/home/pu17449/data2/parameter_transfer_catchments/p5deg-GBM'
catchpath = '/home/pu17449/data2/parameter_transfer_catchments/catchment_vals'
maskfile = '/home/pu17449/data2/EWEMBI-grid/GBM-GRID_0p5deg_v2-2.nc'

# Output
fpickle = '/home/pu17449/data2/parameter_transfer_catchments/GBM-5deg_distances_GBM-hisnowIQR.pkl'
fpickle_reduced = '/home/pu17449/data2/parameter_transfer_catchments/GBM-5deg_distances_GBM-hisnowIQR_reducedset.pkl'
override = False
...
# Inter quartile range (IQR) values calculated over the GBM region:
...
if not os.path.exists(fpickle) or override:
	...
	ingrids = {}
	for var in varnames:
		fpath = os.path.join(gridpath,var+'_p5deg-GBM.tif')
		f = gdal.Open(fpath)
...
#plt.show()
plt.savefig('figs/dissimilarity_map.png')
...
for i,var in enumerate(varnames):
	...
	#plt.show()
	plt.savefig('figs/dissimilarity_map_'+var+'.png')
...
#plt.show()
plt.savefig('figs/bestdonor_map.png')

#########################################################
# Evaluate number of uses by donor catchments
donor_uses = {}
bestlot = np.ma.masked_where(mask10,catcharray[:10,:])
...
#plt.show()
plt.savefig('figs/donor_histogram.png')
...
#plt.show()
plt.savefig('figs/donor_number_exclude'+str(exclude_thresh)+'.png')
...
plt.title('Number of donor catchments, after removing '+str(exclude_thresh)+' uses')
#plt.show()
plt.savefig('figs/donor_number_exclude'+str(exclude_thresh)+'_keep3.png')
...
#plt.show()
plt.savefig('figs/dissimilarity_map_excluded.png')
...
#plt.show()
plt.savefig('figs/rank_map_excluded.png')
